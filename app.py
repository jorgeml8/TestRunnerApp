...
def run_test():
    ...
    return jsonify({'status': 'Test started'}), 200  # Changed to indicate test start
    ...
    try:
        ...
        if environment == 'uat':
            ...
            for test in [test_uat, test2_uat]:
                ...
                result = test.run_test(socketio)  # Run each UAT test
            ...
            result = test_prd.run_test(socketio)  # Run PRD test
